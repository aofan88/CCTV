...
.runsing-admin-shell {
  ...
  color: #e7f2f4;
  background:
    radial-gradient(circle at 84% -10%, rgba(12, 189, 171, 0.16), transparent 34rem),
    radial-gradient(circle at -10% 94%, rgba(15, 107, 148, 0.15), transparent 34rem),
    #05090d;
}

.runsing-admin-shell :deep(.admin-container) {
  max-width: 1480px;
  min-height: 100vh;
  padding: 28px 24px 72px;
}

.runsing-admin-shell :deep(.main-panel) {
  background: rgba(8, 16, 24, 0.9);
  border-color: rgba(105, 145, 165, 0.24);
  border-radius: 8px;
  box-shadow: 0 16px 36px rgba(0, 0, 0, 0.16);
}

.runsing-admin-shell :deep(.panel-header) {
  border-bottom-color: rgba(105, 145, 165, 0.2);
}

.runsing-admin-shell :deep(.panel-title) {
  color: #e9f5f7;
}

.runsing-admin-shell :deep(.panel-title .prompt) {
  color: #15c9bb;
}

.runsing-admin-shell :deep(.stat-card) {
  background: rgba(9, 19, 28, 0.94);
  border-color: rgba(105, 145, 165, 0.22);
  border-radius: 7px;
}

.runsing-admin-shell :deep(.stat-card:hover) {
  background: rgba(10, 28, 35, 0.96);
  border-color: rgba(20, 198, 181, 0.62);
  box-shadow: 0 8px 20px rgba(0, 0, 0, 0.2);
}

.runsing-admin-shell :deep(.stat-main-value) {
  color: #f0fbfb;
}

.runsing-admin-shell :deep(.stat-label) {
  color: #93a9b4;
  letter-spacing: 0;
  text-transform: none;
}

.runsing-admin-shell :deep(.tabs) {
  background: rgba(8, 16, 24, 0.78);
  border-color: rgba(105, 145, 165, 0.2);
  border-radius: 7px;
}

.runsing-admin-shell :deep(.tab-btn) {
  color: #9aacb7;
  letter-spacing: 0;
  text-transform: none;
  border-radius: 5px;
...
.runsing-admin-shell :deep(.tab-btn:hover) {
  background: rgba(20, 93, 84, 0.22);
  color: #f0fbfb;
}

.runsing-admin-shell :deep(.tab-btn.active) {
  background: #14c7b8;
  color: #071012;
}
