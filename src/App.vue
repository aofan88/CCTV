  ...
  <Provider>
    ...
    <Dialog v-model:open="corsDialogOpen">
      <DialogContent class="max-w-xl">
        <DialogHeader>
          <DialogTitle>最後一步</DialogTitle>
          <DialogDescription class="leading-6">
            <p>目前頁面無法連線至潤昇創新 RunSing Innovation 後端。</p>
            <p>純靜態部署時需要前往後端的環境變數配置 <code class="rounded bg-muted px-1.5 py-0.5 font-mono text-foreground">CORS_ALLOWED_ORIGINS</code></p>
          </DialogDescription>
        </DialogHeader>
