...
// ==================== 記憶體 / 硬碟 彙總 ====================
// 離線節點的 ram / disk 為 0，不影響 used 求和；mem_total / disk_total 是靜態庫存資訊，按全量統計
  ...
  <div :class="wrapperClass">
    ...
    <div :class="cardGridClass">
      ...
      >
        <div class="flex h-full flex-col justify-between gap-1">
          <div class="flex items-start justify-between">
            <span class="text-xs font-medium tracking-wider text-muted-foreground">記憶體用量</span>
            <Icon
      ...
      >
        <div class="flex h-full flex-col justify-between gap-1">
          <div class="flex items-start justify-between">
            <span class="text-xs font-medium tracking-wider text-muted-foreground">硬碟用量</span>
            <Icon
      ...
      >
        ...
        >
          <div class="flex h-full flex-col justify-between gap-1">
            <div class="flex items-start justify-between">
              <span class="text-xs font-medium tracking-wider text-muted-foreground">剩餘價值</span>
              <Icon
                icon="tabler:cash" :width="20" :height="20"
                class="text-slate-500/20 group-hover:text-slate-500 transition-colors"
              />
            ...
            <div class="shrink-0 flex flex-col flex-1">
              <div class="flex mb-1 items-center justify-between gap-2">
                ...
                <select
                  ...
                  aria-label="切換匯率基準幣種" @click.stop @change.stop="setExchangeRateBaseCurrency"
                >
      ...
      >
        <div class="flex h-full flex-col justify-between gap-1">
          <div class="flex items-start justify-between">
            <span class="text-xs font-medium tracking-wider text-muted-foreground">即時上行</span>
            <Icon
      ...
      >
        <div class="flex h-full flex-col justify-between gap-1">
          <div class="flex items-start justify-between">
            <span class="text-xs font-medium tracking-wider text-muted-foreground">即時下行</span>
            <Icon
