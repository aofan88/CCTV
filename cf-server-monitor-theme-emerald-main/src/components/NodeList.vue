...
const columns: ColumnConfig[] = [
  ...
  { key: 'mem', label: '記憶體', width: '100px', sortable: true },
  { key: 'disk', label: '硬碟', width: '100px', sortable: true },
  { key: 'traffic', label: '流量', width: '100px', sortable: true },
  { key: 'rate', label: '速率', width: '80px', sortable: true },
  { key: 'latency', label: '延遲', width: '180px', sortable: false },
]
            ...
            <template v-for="col in columns" :key="col.key">
              ...
              <div v-else-if="col.key === 'latency'" class="flex items-center">
                <NodePingListCell
                  ...
                  tabindex="0"
                  class="outline-none"
                  :aria-label="`${node.name} 三網和 BGP 即時延遲`"
